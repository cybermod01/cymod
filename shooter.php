...
echo color("green"," °°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°° \n");
echo color("yellow"," ====JANGAN LUPA SODAQOH==== \n";
echo color("green"," °°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°° \n");
echo color("yellow"," =========== ShooterMagak =============             \n");
echo color("green"," Time  : ".date('[d-m-Y] [H:i:s]')."   \n");
echo color("yellow"," °°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°           \n");
echo color("yellow","[] cara menulis nomor pakai 62xx \n");
function change(){
        $nama = nama();
        ...
        echo "\n".color("yellow","!] Claim voc GO FOOD 25K");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $boba19 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD022620A"}');
